var WebSqlAdapter = function () {
    ...
    this.findByName = function (searchKey) {
        ...
        this.db.transaction(
            ...
            function (error) {
                ...
                alert("Error en la transacci�n dentro del findByName de websql-adapter.js");
            }
        );
        return deferred.promise();
    };

    this.insertArray= function(data)
    {
    ...
    var insertData= function(tx,data)
    {
         var concerts = [
        ...
        for (var i = 0; i < l; i++) {
            c = concerts[i];
            tx.executeSql(sql, [c.id, data[i].title, c.date, c.pic],
                function () {
